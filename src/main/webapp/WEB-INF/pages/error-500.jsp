...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="estatico/css/ace-skins.min.css" />
...
<![endif]-->
		...
		<script src="estatico/js/typeahead-bs2.min.js"></script>

		<!-- page specific plugin scripts -->

		<!-- ace scripts -->

		<script src="estatico/js/ace-elements.min.js"></script>
		<script src="estatico/js/ace.min.js"></script>
